...
/* Version number of DIFFPLUGIN */
#define DIFFPLUGIN_VERSION 2.0.0

/* Major version number of DIFFPLUGIN */
#define DIFFPLUGIN_VERSION_MAJOR 2

/* Micro version number of DIFFPLUGIN */
#define DIFFPLUGIN_VERSION_MICRO 0

/* Minor version number of DIFFPLUGIN */
#define DIFFPLUGIN_VERSION_MINOR 0
...
/* Name of package */
#define PACKAGE "dlvhex-diffplugin"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "dlvhex-devel@lists.sourceforge.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "dlvhex-diffplugin"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "dlvhex-diffplugin 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "dlvhex-diffplugin"
